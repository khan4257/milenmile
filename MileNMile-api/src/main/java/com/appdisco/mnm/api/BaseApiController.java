...
//	@Autowired String majorVersion;
	 ...
	 * Make model and view.
	 *
	 * @param fmt the page format
	 * @param list the list
	 * @return the model and view 
	 * 
	 * @deprecated 
	 * @see #makeModelAndView(String, ResponseCode, ResponseData)
	 */
	@Deprecated
	 ...
	 * @return the model and view
	 */
	protected static ModelAndView makeModelAndView(String fmt, ResponseCode code, ResponseData<?, ?> data) {
		ModelAndView mv = null;

		if ("xml".equals(fmt)) {
			mv = new ModelAndView("pageXmlReport", "head", code);
			mv.addObject("body", data);
		} else if (DEFAULT_PAGE_VIEW_FORMAT.equals(fmt)) {
			mv = new ModelAndView("pageJsonReport", "head", code);
			mv.addObject("body", data);
		}
	 ...
	 * @return the model and view
	 */
	protected static ModelAndView makeModelAndView(String fmt, ResponseCode code) {
		ModelAndView mv = null;
	 ...
	 * @return the model and view
	 */
	protected ModelAndView makeSuccessResponse(String fmt) {
		ResponseCode code = ResponseCode.successCode();
		return makeModelAndView(fmt, code);
	}
