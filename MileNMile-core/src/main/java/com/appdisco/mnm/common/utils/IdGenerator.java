...
public class IdGenerator {
    ...
    public static void main(String[] args) {
    	String str = getUUID();
        System.out.println(String.format("getUUID()       : %s (%d)", str, str.length()));
        str = getSecretCode();
        System.out.println(String.format("getSecretCode() : %s (%d)", str, str.length()));
        
//        str = getCouponCode();
//        System.out.println(String.format("getCouponCode() : %s (%d)", str, str.length()));
